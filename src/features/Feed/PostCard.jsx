...
const PostCard = ({ post, currentUser, onPostUpdate }) => {
    ...
    // 🛑 NEW: Determine the correct user information for the post header
    const postUser = post.user || {};
    const postUserName = post.userName || postUser.name || 'Unknown User';
    // 🛑 CORE FIX: Get the image URL from the nested user object
    const postUserImageUrl = postUser.imageUrl; 
